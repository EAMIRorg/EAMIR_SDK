...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 171.0, 245.0, 68.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 135.5, 211.0, 90.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 319.0, 50.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 319.0, 50.0, 18.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "vj.filepather.maxpat",
				"bootpath" : "/Applications/Max6/Cycling '74/EAMIR SDK/EAMIR_3rd_Party_externals/Modal_Object_Library/Helper Objects/vj.filepather",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
