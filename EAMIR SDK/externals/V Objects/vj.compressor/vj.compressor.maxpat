...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 428.0, 258.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-44" : [ "Input", "Input", 0 ],
			"obj-12" : [ "Bypass", "Bypass", 0 ],
			"obj-34" : [ "slider[3]", "slider[3]", 0 ],
			"obj-2" : [ "Output", "Output", 0 ],
			"obj-52" : [ "Threshold", "Threshold", 0 ],
			"obj-78" : [ "Ratio", "Ratio", 0 ],
