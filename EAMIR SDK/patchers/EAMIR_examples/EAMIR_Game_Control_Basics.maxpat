...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 356.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 141.400024, 67.200073, 62.0, 40.0 ],
									"style" : "",
									"text" : "EAMIR\ncreated by\nV.J. Manzo"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 666.0, 245.0, 215.0, 60.0 ],
					"style" : "",
					"text" : "Game \nController Mapping"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 375.0, 23.0, 272.0, 60.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 708.0, 117.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "route this"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 774.0, 149.0, 118.0, 69.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "EAMIR_interface_grabber_button.maxpat",
					"numinlets" : 2,
					"numoutlets" : 7,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "bang", "bang", "int" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 372.0, 107.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "route this"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "EAMIR_interface_grabber_interface.maxpat",
					"numinlets" : 0,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "list" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 214.0, 586.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 586.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 100"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 537.0, 540.0, 165.0, 33.0 ],
					"style" : "",
					"text" : "Chord Voicing"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 626.0, 395.0, 129.0, 60.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 783.0, 176.0, 33.0 ],
					"style" : "",
					"text" : "MIDI Output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 532.0, 614.0, 333.0, 69.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 532.0, 578.0, 334.0, 38.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 467.0, 531.0, 458.214286, 531.0 ],
					"source" : [ "obj-14", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 393.25, 531.0, 385.928571, 531.0 ],
					"source" : [ "obj-14", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 319.5, 531.0, 313.642857, 531.0 ],
					"source" : [ "obj-14", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 245.75, 531.0, 241.357143, 531.0 ],
					"source" : [ "obj-14", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 172.0, 531.0, 169.071429, 531.0 ],
					"source" : [ "obj-14", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 98.25, 531.0, 96.785714, 531.0 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 509.5, 605.0, 509.5, 605.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 223.5, 606.0, 145.75, 606.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 752.166667, 308.0, 697.5, 308.0 ],
					"source" : [ "obj-44", 5 ]
				}
