...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "dispose", "" ],
					"patching_rect" : [ 529.0, 236.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "t dispose l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 529.0, 289.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 529.0, 177.0, 92.0, 49.0 ],
					"style" : "",
					"text" : "load EAMIR_audio_to_MIDI_fzero"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 575.0, 263.0, 56.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 529.0, 117.0, 53.0, 51.0 ],
					"style" : "",
					"text" : "fzero~ version",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 26.0, 384.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 358.0, 117.0, 154.0, 50.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 117.0, 157.0, 47.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 361.0, 151.000122, 62.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 358.0, 134.0, 158.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 616.0, 176.0, 33.0 ],
					"style" : "",
					"text" : "MIDI Output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 46.0, 244.0, 69.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 26.0, 432.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.0, 410.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "pack 0 100"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 148.0, 214.0, 105.0, 87.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.0, 210.0, 87.0, 87.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.0, 374.0, 182.0, 33.0 ],
					"style" : "",
					"text" : "Pitch to MIDI"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 297.0, 393.0, 182.0, 33.0 ],
					"style" : "",
					"text" : "Audio Output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 47.0, 138.0, 33.0 ],
					"style" : "",
					"text" : "Audio Input"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 412.5, 168.099976, 367.5, 168.099976 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 367.5, 150.000061, 370.5, 150.000061 ],
					"source" : [ "obj-14", 0 ]
				}
