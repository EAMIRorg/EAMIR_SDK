...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 780.0, 123.0, 95.0, 22.0 ],
					"text" : "with latching",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 858.0, 116.0, 38.0, 18.0 ],
					"text" : "BETA",
					"textcolor" : [ 0.211765, 0.027451, 0.431373, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 595.0, 498.0, 117.0, 18.0 ],
					"text" : "with latching"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 296.0, 365.0, 32.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 498.0, 523.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 586.0, 343.0, 69.0, 20.0 ],
					"text" : "ends notes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 594.0, 470.0, 179.0, 33.0 ],
					"text" : "Playback Style"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 593.0, 327.0, 56.0, 20.0 ],
					"text" : "Sustain"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 572.0, 323.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.0, 526.0, 32.5, 22.0 ],
					"text" : "100"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 0.0, 219.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "EAMIR_playback_style_latch.maxpat",
					"numinlets" : 3,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 20.0, 398.0, 571.0, 114.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 533.0, 28.0, 32.5, 22.0 ],
					"text" : "8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 464.0, 28.0, 32.5, 22.0 ],
					"text" : "7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.0, 28.0, 32.5, 22.0 ],
					"text" : "6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 319.0, 28.0, 32.5, 22.0 ],
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.0, 28.0, 32.5, 22.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 28.0, 32.5, 22.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 94.0, 28.0, 32.5, 22.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 28.0, 32.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 21.0, 63.0, 20.0 ],
					"text" : "r mol_chord"
				}
...
,
					"patching_rect" : [ 648.0, 28.0, 129.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 523.0, 546.0, 117.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 645.0, 210.0, 250.0, 69.0 ],
					"text" : "the playback style takes any incoming pitches and arpeggiates them at then tempo and rhythmic value of your choice. "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 517.0, 528.0, 56.0, 20.0 ],
					"text" : "Sustain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 645.0, 93.0, 252.0, 31.0 ],
					"text" : "Chord Accompaniment",
					"textcolor" : [ 0.211765, 0.027451, 0.431373, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.0, 523.0, 61.0, 20.0 ],
					"text" : "Velocity"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 232.0, 525.0, 123.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 530.0, 61.0, 20.0 ],
					"text" : "Pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 523.0, 691.0, 143.0, 33.0 ],
					"text" : "MIDI Output"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 20.0, 551.0, 504.0, 174.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "", "", "", "bang", "" ],
					"patching_rect" : [ 20.0, 63.0, 609.0, 137.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 674.0, 282.0, 82.0, 113.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 645.0, 139.0, 250.0, 69.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 645.0, 67.0, 207.0, 38.0 ],
					"text" : "Playback Style",
					"textcolor" : [ 0.211765, 0.027451, 0.431373, 1.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 545.75, 222.0, 581.5, 222.0 ],
					"source" : [ "obj-14", 7 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 6 ],
					"midpoints" : [ 472.0, 213.5, 463.214285714285722, 213.5 ],
					"source" : [ "obj-14", 6 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 5 ],
					"midpoints" : [ 398.25, 213.5, 390.928571428571445, 213.5 ],
					"source" : [ "obj-14", 5 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 4 ],
					"midpoints" : [ 324.5, 213.5, 318.642857142857167, 213.5 ],
					"source" : [ "obj-14", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 3 ],
					"midpoints" : [ 250.75, 213.5, 246.357142857142861, 213.5 ],
					"source" : [ "obj-14", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 2 ],
					"midpoints" : [ 177.0, 213.5, 174.071428571428584, 213.5 ],
					"source" : [ "obj-14", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 103.25, 213.5, 101.785714285714292, 213.5 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 29.5, 213.5, 29.5, 213.5 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 150.5, 547.0, 150.75, 547.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 581.5, 516.0, 507.5, 516.0 ],
					"source" : [ "obj-59", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 542.5, 59.0, 29.5, 59.0 ],
					"source" : [ "obj-67", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 473.5, 59.0, 29.5, 59.0 ],
					"source" : [ "obj-72", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 397.5, 59.0, 29.5, 59.0 ],
					"source" : [ "obj-73", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 328.5, 59.0, 29.5, 59.0 ],
					"source" : [ "obj-74", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 252.5, 59.0, 29.5, 59.0 ],
					"source" : [ "obj-75", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 183.5, 59.0, 29.5, 59.0 ],
					"source" : [ "obj-76", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 103.5, 59.0, 29.5, 59.0 ],
					"source" : [ "obj-77", 0 ]
				}
...
, 			{
				...
				"patcherrelativepath" : "../../externals/V Objects/vj.banger",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
